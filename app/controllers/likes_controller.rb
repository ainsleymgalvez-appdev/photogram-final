class LikesController < ApplicationController
  ...
  def create
    ...
    if the_like.valid?
      the_like.save
      redirect_to("/users", { :notice => "Like created successfully." })
    else
      redirect_to("/users", { :alert => the_like.errors.full_messages.to_sentence })
    end
  end
  ...
  def update
    ...
    if the_like.valid?
      the_like.save
      redirect_to("/users", { :notice => "Like updated successfully."} )
    else
      redirect_to("/users", { :alert => the_like.errors.full_messages.to_sentence })
    end
  end
  ...
  def destroy
    ...
    redirect_to("/users", { :notice => "Like deleted successfully."} )
  end
end
